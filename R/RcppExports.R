...
rates_cpp <- function(t, y, parms, p_idx, temp_C_fun, pH_fun, SO4_inhibition_fun, conc_fresh_fun, xa_fresh_fun, CTM_cpp, H2SO4_titrate) {
    .Call('_ABM_rates_cpp', PACKAGE = 'ABM', t, y, parms, p_idx, temp_C_fun, pH_fun, SO4_inhibition_fun, conc_fresh_fun, xa_fresh_fun, CTM_cpp, H2SO4_titrate)
}
