pars_indices <- function(pars){
  ...
  'ki_NH3_max','ki_NH4_min','ki_NH4_max','ki_HAC_min','ki_HAC','ki_H2S_min','ki_H2S_max','scale_EF_NH3','area','floor_area',
  'resp','kl','i_meth','i_sr', 'ks_coefficient','ks_SO4','km_urea','conc_fresh', 'carb','pro','lip','ace', 'hyd', 'ace_sr', 'hyd_sr',
  'carb_resp', 'pro_resp', 'lip_resp','COD_conv','xa_fresh','yield', 'rain', 'evap', 'N2O_emis_rate', 'OM','OM_resp','t_min_graze',
  't_max_graze','slurry_graze_reduc')
