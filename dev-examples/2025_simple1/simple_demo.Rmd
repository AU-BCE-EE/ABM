...
We need to set mass transfer coefficient values (m/s) for any species that volatilizes.
...
chem_pars9 <- list(COD_conv = c(CH4 = 1/0.2507, xa = 1/0.7069561,
                               ...
                               CO2_aer = 1/0.436, CO2_sr = 1/1.2, 
                               C_xa = 1/0.3753125),
                   specs = c('NH4p', 'NH3', 'H2S', 'HSm', 'VFA', 'VFAm'),
                   mspec = c(NH4p = 'NH4p', NH3 = 'NH4p', H2S = 'H2S', HSm = 'H2S', VFA = 'VFA', VFAm = 'VFA'),
                   lka = c(NH3 = '- 0.09046 - 2729.31/temp_K', 
                           HSm = '- 3448.7/temp_K + 47.479 - 7.5227 * log(temp_K)',
                           VFAm = '-4.8288 + 21.42/temp_K'),
...
There is an `if` statement that I had to add to `rates()` that I don't like though.
