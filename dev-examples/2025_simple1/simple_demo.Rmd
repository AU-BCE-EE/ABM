...
```{r}
man_pars <- list(VFA_fresh = c(VFA = 2), 
                 pH = 7, dens = 1000)
...
This data frame goes in the `var_pars` argument, which must be a list, even though it has a single element named `var`.
