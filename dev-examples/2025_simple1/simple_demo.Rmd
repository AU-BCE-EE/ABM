...
lines(NH4p_conc ~ time, data = out9, col = 'red')
plot(NH4p ~ time, data = out8, type = 'l')
lines(NH4p ~ time, data = out9, col = 'red')
plot(NH3_emis_cum ~ time, data = out9, type = 'l')
plot(H2S_emis_cum ~ time, data = out9, type = 'l')
plot(VFA_emis_cum ~ time, data = out9, type = 'l')
```
