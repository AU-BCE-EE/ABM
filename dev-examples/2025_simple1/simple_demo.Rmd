...
TIC in slurry shows a lot of change over time, implausible, really.
Emission reduces the concentration to nearly zero when the level is low.
...
plot(CO2_emis_cum / CH4_emis_cum ~ time, data = out11, type = 'l', ylab = 'CO2:CH4', ylim = c(0, 20))
```
