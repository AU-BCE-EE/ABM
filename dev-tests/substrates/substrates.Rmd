...
# Overview
Objective is to demonstrate flexibility in substrate definitions.
Particulate substrates can be entered through `sub_pars` in any number now.
...
out2 <- abm(365, 
            ...
            mic_pars = mic_pars,
            sub_pars = sub_pars,
            add_pars = list(sub_init.pr = 10))
```

```{r}
plot(pr_conc ~ time, data = out2, type = 'l')
```
