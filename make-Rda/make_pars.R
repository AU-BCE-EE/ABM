...
grp_pars_VS_pig2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt = c(m0 = 0.5299, m1 = 0.8478, m2 = 1.223, m3 = 3.179, m4 = 5.299, m5 = 8.4785, sr1 = 9.485),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 8.47, m2 = 8.47, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 5.37),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 5.8),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                     ...
                                     decay_rate = c(all = 0.02),
                                     ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                     qhat_opt = c(m0 = 0.3967, m1 = 0.6349, m2 = 0.882, m3 = 2.38, m4 = 3.97, 
                                                  m5 = 6.349, sr1 = 7.1),
                                     T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                     T_min = c(m0 = 0, m1 = 6.96, m2 = 6.96, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                     T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                     ki_NH3_min = c(all = 0.015),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              ...
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.3973, m1 = 0.636, m2 = 1.0788, m3 = 2.384, m4 = 3.9747, m5 = 6.3596, sr1 = 7.1149),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 1.73, m2 = 1.73, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt =  c(m0 = 0.2947, m1 = 0.47156, m2 = 1.2997, 
                                         m3 = 1.768, m4 = 2.9476, m5 = 4.716, sr1 = 5.276),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 6.87, m2 = 6.87, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 5.17),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
arrh_pars_pig2.0 <- list(lnA = c(VSd_A = 28.717),
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.2622, notVSd = 0.6069, CP = 1.3959),
...
arrh_pars_cattle2.0 <- list(lnA = c(VSd_A = 31.2),
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.33007, notVSd = 0.26399, CP = 0.955),
