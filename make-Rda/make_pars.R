...
grp_pars_VS_pig3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                    yield = c(default = 0.05, sr1 = 0.065),
                    xa_fresh = c(default = 0.0618364),
                    xa_init = c(all = 0.0618364),
                    decay_rate = c(all = 0.02),
                    ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                    qhat_opt = c(m0 = 0.6837, m1 = 0.2860, m2 = 2.2867, m3 = 7.2, m4 = 8, m5 = 8, sr1 = 8.246),
                    T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                    T_min = c(m0 = 0, m1 = 14.65, m2 = 14.65, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                    T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                    ki_NH3_min = c(all = 0.015),
                    ki_NH3_max = c(all = 0.3),
                    ki_NH4_min = c(all = 2.7),
                    ki_NH4_max = c(all = 19.14),
                    ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                    ki_H2S_int = c(default = 1.077, sr1 = 1.42/1.021 * 1.077),
                    ki_H2S_min = c(default = 0.08),
                    IC50_low = c(default = 0.2416, sr1 = 0.2772/0.20854 * 0.2416),
                    ki_HAC = c(default = 0.2977),
                    pH_UL = c(default = 8.0),
                    pH_LL = c(default = 6.5, sr1 = 5.5))

grp_pars_pig3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                       yield = c(default = 0.05, sr1 = 0.065),
                       xa_fresh = c(default = 0.05954219),
                       xa_init = c(all = 0.05954219),
                       decay_rate = c(all = 0.02),
                       ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                       qhat_opt = c(m0 = 0.7108, m1 = 0.1824, m2 = 2.0293, m3 = 8, m4 = 8, m5 = 8, sr1 = 8.77),
                       T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                       T_min = c(m0 = 0, m1 = 12.78, m2 = 12.78, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                       T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                       ki_NH3_min = c(all = 0.015),
                       ki_NH3_max = c(all = 0.3),
                       ki_NH4_min = c(all = 2.7),
                       ki_NH4_max = c(all = 19.14),
                       ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                       ki_H2S_int = c(default = 1.1, sr1 = 1.42/1.021 * 1.1),
                       ki_H2S_min = c(default = 0.08),
                       IC50_low = c(default = 0.251, sr1 = 0.2772/0.20854 * 0.251),
                       ki_HAC = c(default = 0.142),
                       pH_UL = c(default = 8.0),
                       pH_LL = c(default = 6.5, sr1 = 5.5))

grp_pars_VS_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(default = 0.4491658),
                              xa_init = c(all = 0.4491658),
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 2.3946, m1 = 0.0231, m2 = 1.1648, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 13.13, m2 = 13.13, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
                              ki_NH3_max = c(all = 0.3),
                              ki_NH4_min = c(all = 2.7),
                              ki_NH4_max = c(all = 19.14),
                              ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                              ki_H2S_int = c(default = 1.0256, sr1 = 1.42/1.021 * 1.0256),
                              ki_H2S_min = c(default = 0.08),
                              IC50_low = c(default = 0.20854, sr1 = 0.2772),
                              ki_HAC = c(default = 0.31),
                              pH_UL = c(default = 8.0),
...
grp_pars_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                        yield = c(default = 0.05, sr1 = 0.065),
                        xa_fresh = c(default = 0.12818),
                        xa_init = c(all = 0.12818),
                        decay_rate = c(all = 0.02),
                        ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                        qhat_opt = c(m0 = 3.666, m1 = 0.01, m2 = 0.9929, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                        T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
...
arrh_pars_pig3.0 <- list(lnA = c(VSd_A = 31.3),
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.9594, notVSd = 1.5163))
...
arrh_pars_cattle3.0 <- list(lnA = c(VSd_A = 31.3),
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.54506, notVSd = 0.32699))
