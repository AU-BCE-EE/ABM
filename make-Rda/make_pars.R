...
grp_pars_VS_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                            yield = c(default = 0.05, sr1 = 0.065),
                            xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                            xa_init = c(all = 0.06),
                            decay_rate = c(all = 0.02),
                            ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                            qhat_opt = c(m0 = 0.5608, m1 = 0.897, m2 = 1.373337, m3 = 3.3647, m4 = 5.6085, m5 = 8.974, sr1 = 10.039),
                            T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                            T_min = c(m0 = 0, m1 = 4.067586, m2 = 4.067586, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                            T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                            ki_NH3_min = c(all = 0.015),
                            ki_NH3_max = c(all = 5.37),
                            ki_NH4_min = c(all = 2.7),
                            ki_NH4_max = c(all = 5.75),
                            ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                            ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                            ki_H2S_min = c(default = 0.08),
                            IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                         yield = c(default = 0.05, sr1 = 0.065),
                         xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                         xa_init = c(all = 0.06),
                         decay_rate = c(all = 0.02),
                         ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                         qhat_opt = c(m0 = 0.4167, m1 = 0.667, m2 = 0.9692011, m3 = 2.50, m4 = 4.17, 
                                      m5 = 6.67, sr1 = 7.46),
                         T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                         T_min = c(m0 = 0, m1 = 3.321199, m2 = 3.321199, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                         T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                         ki_NH3_min = c(all = 0.015),
                         ki_NH3_max = c(all = 3.223),
                         ki_NH4_min = c(all = 8.19),
                         ki_NH4_max = c(all = 10),
                         ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                         ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                         ki_H2S_min = c(default = 0.08),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                              xa_init = c(all = 0.06),
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.4601, m1 = 0.7364, m2 = 1.154107, m3 = 2.761, m4 = 4.6045, m5 = 7.3675, sr1 = 8.4429),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 1.663, m2 = 1.663, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt =  c(m0 = 0.2573, m1 = 0.4118, m2 =  1.097, 
                                         m3 = 1.17, m4 = 2.574, m5 = 4.1187, sr1 = 4.6079),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 5.852, m2 = 5.852, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 5.105),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_VS_digestate2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                 yield = c(default = 0.05, sr1 = 0.065),
                                 xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                                 xa_init = c(all = 0.06),
                                 decay_rate = c(all = 0.02),
                                 ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                 qhat_opt = c(m0 = 1.4475, m1 = 2.3175, m2 = 5.955841, m3 = 8.6859, m4 = 14.485, m5 = 23.175, sr1 = 25.928),
                                 T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                 T_min = c(m0 = 0, m1 = 1.558126, m2 = 1.558126, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                 T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                 ki_NH3_min = c(all = 0.015),
                                 ki_NH3_max = c(all = 1.528),
                                 ki_NH4_min = c(all = 2.7),
...
arrh_pars_pig2.0 <- list(lnA =  30.35136,
                         E_CH4 = 81000, 
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.3322882, notVSd = 0.6837892, CP = 1.363536),
                         kl = c(NH3 = 336, NH3_floor = 0.36*337, H2S = 0.02),
                         scale_EF_NH3 = 0.0000048)

arrh_pars_cattle2.0 <- list(lnA = 29.02884,
                            E_CH4 = 81000, 
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.4299, notVSd = 0.2456, CP = 1.02543),
                            kl = c(NH3 = 1000, NH3_floor = 0.36*1000, H2S = 0.02),
                            scale_EF_NH3 = 0.0000048)

arrh_pars_digestate2.0 <- list(lnA = 29.02884,
                               E_CH4 = 81000, 
                               A = c(xa_dead= 22497134.8, starch = 5.86*10^18, Cfat = 0, CPs = 1.763612 * 10^12, CPf = 4.10669 * 10^11, RFd = 2.567944 * 10^8, VSd = 22497134.8, urea = 4.38*10^15), 
                               E = c(xa_dead= 55609, starch = 109400, Cfat = 0, CPs = 87515.5450, CPf = 69361.3, RFd = 57867, VSd = 55609, urea = 81559),  # CP is for GRA treatment in MILK project
                               R = 8.314,  
                               VS_CH4 = 6.67,
                               scale_alpha_opt = list(VSd = 2.582425, notVSd = 0.23923, CP = 1.0255),
                               kl = c(NH3 = 1000, NH3_floor = 0.36*1000, H2S = 0.02),
                               scale_EF_NH3 = 0.0000048)
