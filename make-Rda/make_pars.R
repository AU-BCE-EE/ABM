...
chem_pars2.0 <- list(COD_conv = c(CH4 = 1/0.2507, xa = 1/0.7069561, RFd = 1/0.8444792, iNDF = 1/0.8444792, starch = 1/0.8444792, 
                              Cfat = 1/0.3117844, CP = 1/0.6541602, VFA = 1/0.9383125, S = 1/0.5015, VS = 1/0.69, CO2_ureo = 1/1.57,
                              N_CP = 1/0.1014, C_xa = 1/0.3753125, C_RFd = 1/0.376, C_iNDF = 1/0.376, N_xa = 1/0.08754375,
...
grp_pars_pig2.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                       ...
                       decay_rate = c(all = 0.02),
                       ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                       qhat_opt = c(m0 = 0.694, m1 = 0.227, m2 = 1.87, m3 = 8, m4 = 8, m5 = 8, sr1 = 8.95),
                       T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                       T_min = c(m0 = 0, m1 = 12.81, m2 = 12.81, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                       T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                       ki_NH3_min = c(all = 0.015),
                       ki_NH3_max = c(all = 3.219),
                       ki_NH4_min = c(all = 2.7),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(m0 = 0.3, m1 = 0.3, m2 = 0.3, sr1 = 0.3),
                              xa_init = c(all = 0.3),
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                        ...
                        decay_rate = c(all = 0.02),
                        ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                        qhat_opt = c(m0 = 0.0444, m1 = 0.01, m2 = 1.59, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                        T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                        T_min = c(m0 = 0, m1 = 0.001, m2 = 0.001, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                        T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                        ki_NH3_min = c(all = 0.015),
                        ki_NH3_max = c(all = 0.2066),
                        ki_NH4_min = c(all = 2.7),
                        ki_NH4_max = c(all = 19.14),
                        ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                        ki_H2S_int = c(default = 1.02, sr1 = 1.42),
...
grp_pars_VS_digestate2.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(m0 = 0.3, m1 = 0.3, m2 = 0.3, sr1 = 0.3),
                              xa_init = c(all = 0.3),
                              decay_rate = c(all = 0.02),
...
grp_pars_digestate2.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                           yield = c(default = 0.05, sr1 = 0.065),
                           xa_fresh = c(m0 = 0.3, m1 = 0.3, m2 = 0.3, sr1 = 0.3),
                           xa_init = c(all = 0.3),
                           decay_rate = c(all = 0.02),
...
man_pars_VS_pig2.0$conc_fresh[['Cfat']] + man_pars_VS_pig2.0$conc_fresh[['RFd']] + man_pars_VS_pig2.0$conc_fresh[['CP']] + 
...
man_pars_VS_cattle2.0$conc_fresh[['Cfat']] + man_pars_VS_cattle2.0$conc_fresh[['RFd']] + man_pars_VS_cattle2.0$conc_fresh[['CP']] + 
...
man_pars_VS_digestate2.0$conc_fresh['VSd'] <- (man_pars_VS_digestate2.0$conc_fresh[['starch']] + man_pars_VS_digestate2.0$conc_fresh[['xa_dead']] +
                                              man_pars_VS_digestate2.0$conc_fresh[['Cfat']] + man_pars_VS_digestate2.0$conc_fresh[['RFd']] + man_pars_VS_digestate2.0$conc_fresh[['CP']])
...
arrh_pars_cattle2.0 <- list(lnA = c(VSd_A = 31.2),
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.815577, notVSd = 0.1993, CP = 1.068),
...
arrh_pars_digestate2.0 <- list(lnA = c(VSd_A = 31.2),
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.554, notVSd = 0.6878, CP = 1),
                            kl = c(NH3 = 54, NH3_floor = 23, H2S = 0.02),
                            scale_EF_NH3 = 1)
...
digestate_pars2.0 <- c(grp_pars_digestate2.0, arrh_pars_digestate2.0, man_pars_digestate2.0)
...
save(grp_pars_digestate2.0, file = '../data/grp_pars_digestate2.0.rda')
...
save(man_pars_digestate2.0, file = '../data/man_pars_digestate2.0.rda')
...
save(digestate_pars2.0, file = '../data/digestate_pars2.0.rda')
