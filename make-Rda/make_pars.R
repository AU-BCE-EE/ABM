...
grp_pars_VS_pig3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                    yield = c(default = 0.05, sr1 = 0.065),
                    xa_fresh = c(default = 0.04946912),
                    xa_init = c(all = 0.04946912),
                    decay_rate = c(all = 0.02),
                    ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                    qhat_opt = c(m0 = 0.7214, m1 = 0.2767, m2 = 1.6144, m3 = 7.2, m4 = 8, m5 = 8, sr1 = 7.148),
                    T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                    T_min = c(m0 = 0, m1 = 12.97, m2 = 12.97, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                    T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                    ki_NH3_min = c(all = 0.015),
                    ki_NH3_max = c(all = 0.3144),
                    ki_NH4_min = c(all = 2.7),
                    ki_NH4_max = c(all = 19.152),
                    ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                    ki_H2S_int = c(default = 1.033, sr1 = 1.42/1.021 * 1.033),
                    ki_H2S_min = c(default = 0.08),
                    IC50_low = c(default = 0.260, sr1 = 0.2772/0.20854 * 0.260),
                    ki_HAC = c(default = 0.22035),
                    pH_UL = c(default = 8.0),
                    pH_LL = c(default = 6.5, sr1 = 5.5))

grp_pars_pig3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                       yield = c(default = 0.05, sr1 = 0.065),
                       xa_fresh = c(default = 0.03870242),
                       xa_init = c(all = 0.03870242),
                       decay_rate = c(all = 0.02),
                       ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                       qhat_opt = c(m0 = 0.75105, m1 = 0.1794, m2 = 1.7171, m3 = 8, m4 = 8, m5 = 8, sr1 = 5.54),
                       T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                       T_min = c(m0 = 0, m1 = 12.53, m2 = 12.53, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                       T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                       ki_NH3_min = c(all = 0.015),
                       ...
                       ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                       ki_H2S_int = c(default = 1.054, sr1 = 1.42/1.021 * 1.054),
                       ki_H2S_min = c(default = 0.08),
                       IC50_low = c(default = 0.3428, sr1 = 0.2772/0.20854 * 0.3428),
                       ki_HAC = c(default = 0.155),
                       pH_UL = c(default = 8.0),
                       pH_LL = c(default = 6.5, sr1 = 5.5))

grp_pars_VS_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(default = 0.25),
                              xa_init = c(all = 0.25),
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.915, m1 = 0.023, m2 = 2.3539, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.928),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 15, m2 = 15, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
                              ki_NH3_max = c(all = 0.2986),
                              ki_NH4_min = c(all = 2.7),
                              ki_NH4_max = c(all = 19.14),
                              ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                              ki_H2S_int = c(default = 1.289756, sr1 = 1.42/1.021 * 1.289756),
                              ki_H2S_min = c(default = 0.08),
                              IC50_low = c(default = 0.20854, sr1 = 0.2772),
                              ki_HAC = c(default = 0.31),
                              pH_UL = c(default = 8.0),
...
grp_pars_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','sr1'),
                        yield = c(default = 0.05, sr1 = 0.065),
                        xa_fresh = c(default = 0.5),
                        xa_init = c(all = 0.5),
                        decay_rate = c(all = 0.02),
                        ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                        qhat_opt = c(m0 = 1, m1 = 0.01, m2 = 0.9929, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                        T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                        ...
                        ki_NH4_max = c(all = 19.14),
                        ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                        ki_H2S_int = c(default = 0.9299, sr1 = 1.42/1.021 * 0.9299),
                        ki_H2S_min = c(default = 0.08),
                        IC50_low = c(default = 0.20854, sr1 = 0.2772),
                        ki_HAC = c(default = 0.31),
                        pH_UL = c(default = 8.0),
...
arrh_pars_pig3.0 <- list(lnA = c(VSd_A = 31.3),
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.7238, notVSd = 0.8050))

arrh_pars_cattle3.0 <- list(lnA = c(VSd_A = 30.3),
                         E_CH4 = c(VSd_A = 81000), 
                         A = c(xa_dead= 3.61383 * 10^12, starch = 5.86*10^18, Cfat = 0, CP = 181.8, RFd = 1.499476 * 10^12, VSd = 3.61383 * 10^12, urea = 4.38*10^15), 
                         E = c(xa_dead= 81557, starch = 109400, Cfat = 0, CP = 23890, RFd = 81052, VSd = 81557, urea = 81559),  
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 1.0454, notVSd = 1.5))
