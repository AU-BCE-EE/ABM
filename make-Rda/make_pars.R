...
grp_pars_VS_pig2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                 ...
                 decay_rate = c(all = 0.02),
                 ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                 qhat_opt = 1.028348 * c(m0 = 0.5, m1 = 0.8, m2 = 1.149649, m3 = 7.2, m4 = 8, m5 = 8, sr1 = 8.95),
                 T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                 T_min = c(m0 = 0, m1 = 9.27, m2 = 9.27, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                 T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                 ki_NH3_min = c(all = 0.015),
                 ki_NH3_max = c(all = 5.37),
                 ki_NH4_min = c(all = 2.7),
                 ki_NH4_max = c(all = 5.6),
                 ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                 ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                 ki_H2S_min = c(default = 0.08),
                 IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_pig2.0 <- list(grps = c('m0', 'm1', 'm2', 'm3','m4','m5','sr1'),
                        ...
                        decay_rate = c(all = 0.02),
                        ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                        qhat_opt = 0.807296 * c(m0 = 0.5, m1 = 0.8, m2 = 1.127, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                        T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                        T_min = c(m0 = 0, m1 = 11.5, m2 = 11.5, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                        T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                        ki_NH3_min = c(all = 0.015),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              ...
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = 0.7513156 *  c(m0 = 0.5, m1 = 0.8, m2 = 1.479571, m3 = 8.0, m4 = 8, m5 = 8, sr1 = 8.95),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 20, m2 = 20, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5', 'sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt = 0.6781025 * c(m0 = 0.5, m1 = 0.8, m2 = 1.637984, m3 = 3, m4 = 5, m5 = 8, sr1 = 8.95),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 11.29, m2 = 11.29, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 6.65),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_VS_digestate2.0 <- list(grps = c('m0', 'm1', 'm2', 'm3', 'm4', 'm5', 'sr1'),
                                 ...
                                 decay_rate = c(all = 0.02),
                                 ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                 qhat_opt = c(m0 = 0.11, m1 = 1.92, m2 = 1.46, m3 = 3.4, m4 = 5, m5 = 8, sr1 = 8.95, sr1 = 9),
                                 T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36,  m4 = 43.75, m5 = 55, sr1 = 43.75),
                                 T_min = c(m0 = 0,  m1 = 11.36,  m2 = 11.36,  m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                 T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                 ki_NH3_min = c(all = 0.015),
...
man_pars_pig2.0 <- list(conc_fresh = list(sulfide = 0.01, urea = 3.17, sulfate = 0.01, TAN = 0.0, starch = 5.25, 
                                      ...
                                      ash = 15, VSd_A = 50, VSnd_A = 17), pH = 7, dens = 1000)
...
man_pars_digestate2.0 <- list(conc_fresh = list(sulfide = 0, urea = 0, sulfate = 0, TAN = 3, starch = 0.29, 
                                             ...
                                             ash = 15, VSd_A = 50, VSnd_A = 17), pH = 8, dens = 1000)
...
arrh_pars_pig2.0 <- list(lnA  = 28.717,
                         E_CH4 = 78479.55, 
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.2694824, notVSd = 0.5893, CP = 1.39),
                         kl = c(NH3 = 351, NH3_floor = 0.36*351, H2S = 0.02),
                         scale_EF_NH3 = 0.0000048)

arrh_pars_cattle2.0 <- list(lnA = 31.2,
                            E_CH4 = 81000, 
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.8108622, notVSd = 0.222, CP = 1.266),
                            kl = c(NH3 = 976, NH3_floor = 0.36*976, H2S = 0.02),
                            scale_EF_NH3 = 0.0000048)

arrh_pars_digestate2.0 <- list(lnA = 31.2,
                               E_CH4 = 81000, 
                               A = c(xa_dead= 22497134.8, starch = 5.86*10^18, Cfat = 0, CPs = 1.763612 * 10^12, CPf = 4.10669 * 10^11, RFd = 2.567944 * 10^8, VSd = 22497134.8, urea = 4.38*10^15), 
