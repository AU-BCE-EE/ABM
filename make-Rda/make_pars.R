...
grp_pars_VS_pig3.0 <-   list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                         yield = c(default = 0.05, sr1 = 0.065),
                                         xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                                         xa_init = c(all = 0.06),
                                         decay_rate = c(all = 0.02),
                                         ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                         qhat_opt = c(m0 = 0.445368, m1 = 0.7123819, m2 = 1.02222, m3 = 2.6719, m4 = 4.4541, m5 = 7.1264, sr1 = 7.9728),
                                         T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                         T_min = c(m0 = 0, m1 = 9.48, m2 = 9.48, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                         T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                         ki_NH3_min = c(all = 0.015),
                                         ki_NH3_max = c(all = 5.37),
                                         ki_NH4_min = c(all = 2.7),
                                         ki_NH4_max = c(all = 6.0157),
                                         ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                                         ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                                         ki_H2S_min = c(default = 0.08),
                                         IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_pig3.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                         yield = c(default = 0.05, sr1 = 0.065),
                         xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                         xa_init = c(all = 0.06),
                         decay_rate = c(all = 0.02),
                         ...
                         ki_H2S_min = c(all = 0.08),
                         ki_H2S_max = c(all = 0.295, sr1 = 0.392),
                         ki_HAC_min = c(all = 0.05),
                         ki_HAC_max = c(all = 0.31),
                         pH_UL = c(default = 8.0),
                         pH_LL = c(default = 6.5, sr1 = 5.5))

grp_pars_VS_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              yield = c(default = 0.05, sr1 = 0.065),
                              xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                              xa_init = c(all = 0.06),
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.1344858, m1 = 0.2152, m2 = 0.5564483, 
                                           m3 = 0.611466, m4 = 1.34557, m5 = 2.152997, sr1 = 2.40849),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 1.1545, m2 = 1.1545, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
                              ki_NH3_max = c(all = 1.528),
                              ki_NH4_min = c(all = 2.7),
                              ki_NH4_max = c(all = 7.06),
                              ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                              ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                              ki_H2S_min = c(default = 0.08),
                              IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_cattle3.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           yield = c(default = 0.05, sr1 = 0.065),
                           xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                           xa_init = c(all = 0.06),
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt =  c(m0 = 0.30069, m1 = 0.484367, m2 = 0.7781104, m3 = 1.8166, m4 = 3.02705, m5 = 4.84546, sr1 = 5.4206),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 7.4587, m2 = 7.4587, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 4.7838),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_VS_digestate3.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                 yield = c(default = 0.05, sr1 = 0.065),
                                 xa_fresh = c(m0 = 0.06, m1 = 0.06, m2 = 0.06, m3 = 0.06, m4 = 0.06, m5 = 0.06, sr1 = 0.06),
                                 xa_init = c(all = 0.06),
                                 decay_rate = c(all = 0.02),
                                 ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                 qhat_opt = c(m0 = 1.0254, m1 = 1.6418, m2 = 2.839102, m3 = 6.1537, m4 = 10.262, m5 = 16.419, sr1 = 18.369),
                                 T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                 T_min = c(m0 = 0, m1 = 2.44, m2 = 2.44, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                 T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                 ki_NH3_min = c(all = 0.015),
                                 ki_NH3_max = c(all = 1.528),
                                 ki_NH4_min = c(all = 2.7),
                                 ki_NH4_max = c(all = 6.98),
                                 ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                                 ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                                 ki_H2S_min = c(default = 0.08),
                                 IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
man_pars_VS_pig3.0$conc_fresh[['Cfat']] + man_pars_VS_pig3.0$conc_fresh[['RFd']] + man_pars_VS_pig3.0$conc_fresh[['CPs']] + 
man_pars_VS_pig3.0$conc_fresh[['CPf']] +
...
man_pars_VS_cattle3.0$conc_fresh[['Cfat']] + man_pars_VS_cattle3.0$conc_fresh[['RFd']] + man_pars_VS_cattle3.0$conc_fresh[['CPs']] + 
man_pars_VS_cattle3.0$conc_fresh[['CPf']] +  
...
man_pars_VS_digestate3.0$conc_fresh['VSd'] <- (man_pars_VS_digestate3.0$conc_fresh[['starch']] + man_pars_VS_digestate3.0$conc_fresh[['xa_dead']] +
                                              man_pars_VS_digestate3.0$conc_fresh[['Cfat']] + man_pars_VS_digestate3.0$conc_fresh[['RFd']] + man_pars_VS_digestate3.0$conc_fresh[['CPs']] +
                                              man_pars_VS_digestate3.0$conc_fresh[['CPf']])
...
arrh_pars_cattle3.0 <- list(lnA = 29.67188,
                            E_CH4 = 81000, 
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.5766709, notVSd = 0.2002144, CP = 0.79077),
