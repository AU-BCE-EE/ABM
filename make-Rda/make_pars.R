...
grp_pars_VS_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                       ...
                                       decay_rate = c(all = 0.02),
                                       ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                       qhat_opt = c(m0 = 0.51786, m1 = 0.8286, m2 = 1.18459, m3 = 3.1071, m4 = 5.1786, m5 = 8.2858, sr1 = 9.2698),
                                       T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                       T_min = c(m0 = 0, m1 = 9.59, m2 = 9.59, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                       T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                       ki_NH3_min = c(all = 0.015),
                                       ki_NH3_max = c(all = 5.37),
                                       ki_NH4_min = c(all = 2.7),
                                       ki_NH4_max = c(all = 5.77),
                                       ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                                       ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                                       ki_H2S_min = c(default = 0.08),
                                       IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                         ...
                         decay_rate = c(all = 0.02),
                         ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                         qhat_opt = c(m0 = 0.4071, m1 = 0.6515, m2 = 0.9121, m3 = 2.4431, m4 = 4.072, 
                                      m5 = 6.515, sr1 = 7.289),
                         T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                         T_min = c(m0 = 0, m1 = 11.48, m2 = 11.48, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                         T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                         ki_NH3_min = c(all = 0.015),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              ...
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.3407, m1 = 0.5454, m2 = 0.9717, m3 = 2.044, m4 = 3.408, m5 = 5.4535, sr1 = 6.1012),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 12.2, m2 = 12.2, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt = c(m0 = 0.389850, m1 = 0.623760, m2 = 1.6445, 
                                        m3 = 2.339100, m4 = 3.899075, m5 = 6.238520, sr1 = 6.97935),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 11.3, m2 = 11.3, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 6.31),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
arrh_pars_cattle2.0 <- list(lnA = 32.20492,
                            E_CH4 = 74775.38, 
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 1.1517, notVSd = 0.316, CP = 0.955),
