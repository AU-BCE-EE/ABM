...
grp_pars_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                         ...
                         decay_rate = c(all = 0.02),
                         ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                         qhat_opt = c(m0 = 0.3716, m1 = 0.5948, m2 = 0.8229, m3 = 2.2297, m4 = 3.7189, 
                                      m5 = 5.948, sr1 = 6.652),
                         T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              ...
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = 1.032396  *c(m0 = 0.4215, m1 = 0.6748, m2 = 1.168204, m3 = 2.529, m4 = 4.2175, m5 = 6.748, sr1 = 7.5496),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 1.69, m2 = 1.69, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 6.515, m2 = 6.515, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
...
arrh_pars_pig2.0 <- list(lnA =  30.35136,
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.24307, notVSd = 0.5736, CP = 1.388),
...
arrh_pars_cattle2.0 <- list(lnA = 29.02884,
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.301996, notVSd = 0.23923, CP = 1.0255),
