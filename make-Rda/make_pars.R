...
grp_pars_VS_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                            ...
                            decay_rate = c(all = 0.02),
                            ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                            qhat_opt = c(m0 = 0.4765, m1 = 0.76239, m2 = 1.0903, m3 = 2.8587, m4 = 4.7651, m5 = 7.6243, sr1 = 8.53),
                            T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                            T_min = c(m0 = 0, m1 = 8.58, m2 = 8.58, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                            T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                            ki_NH3_min = c(all = 0.015),
...
grp_pars_pig2.0 <-  list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                         ...
                         decay_rate = c(all = 0.02),
                         ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                         qhat_opt = c(m0 = 0.3716, m1 = 0.5948, m2 = 0.8228, m3 = 2.2297, m4 = 3.7189, 
                                      m5 = 5.948, sr1 = 6.652),
                         T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                         T_min = c(m0 = 0, m1 = 7.02, m2 = 7.02, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                         T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                         ki_NH3_min = c(all = 0.015),
...
grp_pars_VS_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                              ...
                              decay_rate = c(all = 0.02),
                              ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                              qhat_opt = c(m0 = 0.4830, m1 = 0.773, m2 = 1.44595, m3 = 2.898, m4 = 4.833, m5 = 7.733, sr1 = 8.8618),
                              T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                              T_min = c(m0 = 0, m1 = 1.619, m2 = 1.619, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                              T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                              ki_NH3_min = c(all = 0.015),
...
grp_pars_cattle2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                           ...
                           decay_rate = c(all = 0.02),
                           ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                           qhat_opt =  c(m0 = 0.2547, m1 = 0.407563, m2 =  1.085506, 
                                         m3 = 1.15788, m4 = 2.54757, m5 = 4.0759, sr1 = 4.56),
                           T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                           T_min = c(m0 = 0, m1 = 6.34, m2 = 6.34, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                           T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                           ki_NH3_min = c(all = 0.015),
                           ki_NH3_max = c(all = 0.465),
                           ki_NH4_min = c(all = 2.7),
                           ki_NH4_max = c(all = 5.09),
                           ki_H2S_slope = c(default = -0.10623, sr1 = -0.1495),
                           ki_H2S_int = c(default = 1.02, sr1 = 1.42),
                           ki_H2S_min = c(default = 0.08),
                           IC50_low = c(default = 0.20854, sr1 = 0.2772),
...
grp_pars_VS_digestate2.0 <- list(grps = c('m0', 'm1', 'm2','m3','m4','m5','sr1'),
                                 ...
                                 decay_rate = c(all = 0.02),
                                 ks_coefficient = c(default = 1.153337, sr1 = 0.461335),
                                 qhat_opt = c(m0 = 0.606865, m1 = 0.97156, m2 = 1.900215, m3 = 3.64119, m4 = 6.07225, m5 = 9.71560, sr1 = 10.8697),
                                 T_opt = c(m0 = 18, m1 = 18, m2 = 28, m3 = 36, m4 = 43.75, m5 = 55, sr1 = 43.75),
                                 T_min = c(m0 = 0, m1 = 1.597, m2 = 1.597, m3 = 15, m4 = 26.25, m5 = 30, sr1 = 0),
                                 T_max = c(m0 = 25, m1 = 25, m2 = 38, m3 = 45, m4 = 51.25, m5 = 60, sr1 = 51.25),
                                 ki_NH3_min = c(all = 0.015),
                                 ki_NH3_max = c(all = 1.528),
                                 ki_NH4_min = c(all = 2.7),
...
arrh_pars_pig2.0 <- list(lnA =  30.35136,
                         ...
                         R = 8.314,  
                         VS_CH4 = 6.67,
                         scale_alpha_opt = list(VSd = 0.24307, notVSd = 0.5730, CP = 1.3879),
...
arrh_pars_cattle2.0 <- list(lnA = 29.02884,
                            ...
                            R = 8.314,  
                            VS_CH4 = 6.67,
                            scale_alpha_opt = list(VSd = 0.2477, notVSd = 0.24065, CP = 1.02543),
...
arrh_pars_digestate2.0 <- list(lnA = 29.02884,
                               ...
                               R = 8.314,  
                               VS_CH4 = 6.67,
                               scale_alpha_opt = list(VSd = 0.58666, notVSd = 0.23923, CP = 1.0255),
                               kl = c(NH3 = 1000, NH3_floor = 0.36*1000, H2S = 0.02),
                               scale_EF_NH3 = 0.0000048)
