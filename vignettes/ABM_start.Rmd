...
crude protein that is quickly degraded (CPf), crude protein that is slowly degraded (CPs), crude fats (Cfat), residual degradable fiber (RFd), starch and sugars (starch), and even more components. 
