...
First we will start with a demonstration using the default input parameters, which reflect manure production in a pig-house with 1000 grower-finisher pigs. In-house slurry pits are 0.6 m deep and the slurry is flushed out of the pig-house every 28 days, leaving 5 cm of residual slurry inside the in-house slurry pits. The slurry temperature is 20&degC. The amount of degradable VS content of raw pig manure is set to 75 gCOD/kg manure (feces + urine). 
